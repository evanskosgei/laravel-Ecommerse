...
//$total = UserController::cartItems();
?>-->
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Home | Kanga-Carders</title>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +254 725132825</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> info@studioskanga.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
		...
		<div class="header-bottom"><!--header-bottom-->
			<div class="container">
				<div class="row">
					...
					<form method="" action="{{route('search.item')}}">
					<div class="col-sm-3">
						<div class="search_box pull-right">
							<input type="search" name="query" placeholder="Search item type here"/>
						</div>
					</div>
					</form>
				</div>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1><span>kanga</span>-MainSite</h1>
									<h2>Kanga Carders Site</h2>
							...
							<div class="item">
								<div class="col-sm-6">
									<h1><span>kanga</span>-MainSite</h1>
									<h2>100% Legit sellers in town</h2>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
									<button type="button" class="btn btn-default get">Get it now</button>
								</div>
								<div class="col-sm-6">
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<a href="itemdetals/{{$items['id']}}"><img src="{{asset('image')}}/{{$items->itemImage}}" style="max-height: 100px; width:auto;"  alt="" /></a>
										<h2>{{$items->sellPrice}}</h2>
					...
					<div class="col-sm-2">
						<div class="single-widget">
							...
							<ul class="nav nav-pills nav-stacked">
								...
								<li><a href="#">Bank logs</a></li>
								<li><a href="#">Fullz</a></li>
